...
<section class=" bg-gradient-to-t from-gray-300 to-white text-black">
	<div class="container text-center relative pt-10 w-full lg:w-2/3">
    	...
    	<p class=" pb-10">No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</p>
	</div>	
	<div class="container text-center relative w-full lg:w-2/6">
		<?php include 'partial/form-password-email.php';?>
	</div>	
